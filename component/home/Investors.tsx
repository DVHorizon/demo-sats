...
const chartPoints: ChartPoint[] = [
    { id: 1, date: "2026/5/15", price: "3.20 SGD", volume: "12,450,000", cx: 8, cy: 34, tooltipLeft: "0%" },
    { id: 2, date: "2026/6/2", price: "3.95 SGD", volume: "16,311,600", cx: 30, cy: 25, tooltipLeft: "8%" },
    { id: 3, date: "2026/6/20", price: "4.25 SGD", volume: "18,920,400", cx: 52, cy: 18, tooltipLeft: "25%" },
    { id: 4, date: "2026/7/12", price: "4.50 SGD", volume: "14,110,000", cx: 75, cy: 12, tooltipLeft: "42%" },
    { id: 5, date: "2026/8/3", price: "4.79 SGD", volume: "21,050,000", cx: 95, cy: 6, tooltipLeft: "52%" },
];
            ...
            <div className="w-full max-w-[1780px] mx-auto px-4 lg:px-10">
                ...
                <div className="mb-10 lg:mb-14">
                    ...
                    <p className="text-[#50284f]/80 text-base lg:text-lg max-w-2xl leading-relaxed mb-6 font-normal">
                        As a technology-driven, people-led organisation, we’re dedicated to delivering soaring results for our customers, communities and shareholders and long-term sustainable growth.
                    </p>
                    <Link
                        href="/investors"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 items-stretch">
                    ...
                    <div className="bg-white rounded-[24px] border border-gray-300 p-6 lg:p-8 flex flex-col items-start">
                        <h3
                            className="text-2xl font-bold text-[#482146] min-h-[72px] flex items-start mb-4"
                            style={{ fontFamily: "'Century Gothic', 'Arial', sans-serif" }}
                        >
                    ...
                    <div className="bg-white rounded-[24px] border border-gray-300 p-6 lg:p-8 flex flex-col items-start">
                        ...
                        <div className="w-full mb-4">
                            ...
                            <div className="flex items-center gap-3 mb-2">
                                <div className="w-0 h-0 border-l-[16px] border-l-transparent border-r-[16px] border-r-transparent border-b-[26px] border-b-[#82c974]" />
                            ...
                            <div className="w-full border border-gray-300 p-3 bg-white mb-4 overflow-visible">
                                <div className="relative w-full h-[175px] flex overflow-visible">
                                    ...
                                    >
                                        ...
                                        {/* Đồ thị gấp khúc SVG */}
                                        <svg className="absolute inset-0 w-full h-full overflow-visible pointer-events-none" viewBox="0 0 100 50" preserveAspectRatio="none">
                                            <path
                                        ...
                                        {hoveredPoint && (
                                            <>
                                                ...
                                                <div
                                                    className="absolute bg-white border-[1.5px] border-[#2b5cb8] rounded-[10px] p-2.5 shadow-[0_4px_12px_rgba(0,0,0,0.12)] z-30 text-[#111111] pointer-events-none transition-all duration-200 min-w-[160px]"
                                                    style={{
                                                        left: hoveredPoint.tooltipLeft,
                                                        bottom: "-25px",
                                                    }}
                                                >
                                                    <p className="text-[#333333] text-xs font-normal mb-0.5">{hoveredPoint.date}</p>
                                                    <p className="text-sm font-bold text-black mb-0.5">
                                                        SATS Ltd. <span className="font-normal text-xs text-[#333333]">{hoveredPoint.price}</span>
                                                    </p>
                                                    <p className="text-xs text-[#333333] font-normal">Volume {hoveredPoint.volume}</p>
                                                </div>
                                            </>
                                        )}
                    ...
                    <div className="bg-white rounded-[24px] border border-gray-300 p-6 lg:p-8 flex flex-col items-start">
                        <h3
                            className="text-2xl font-bold text-[#482146] min-h-[72px] flex items-start mb-4 leading-snug"
                            style={{ fontFamily: "'Century Gothic', 'Arial', sans-serif" }}
                        >
                        ...
                        <div className="w-full mb-6">
                            <div className="space-y-4 text-xs text-gray-700">
                                {/* Mốc 1 */}
                                <div>
                                    <p className="font-bold text-xl mb-0.5">01 Oct 2026 - 31 Dec 2026</p>
                                    <p className="text-gray-600 text-lg mb-1">3rd Quarter (FY27) Events</p>
                                ...
                                {/* Mốc 2 */}
                                <div>
                                    <p className="font-bold text-xl mb-0.5">01 Jul 2026 - 30 Sep 2026</p>
                                    <p className="text-gray-600 text-lg mb-1">2nd Quarter (FY27) Events</p>
