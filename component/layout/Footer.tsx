...
export default function Footer () {
  return (
    <footer className='relative overflow-hidden bg-linear-to-b from-[#3a3a3a] to-[#585858] text-white py-12 text-xs'>
      ...
      <div className='absolute inset-0 z-0 pointer-events-none flex justify-end items-end'>
        <svg
          ...
          className='pt-5 w-full h-full max-h-87.5 object-contain'
      ...
      <div className='relative z-10 w-full max-w-[1780px] mx-auto px-4 lg:px-10 grid grid-cols-1 md:grid-cols-4 gap-8'>
        ...
        <div className='text-white'>
          ...
          <ul className='flex flex-wrap items-center gap-4 mt-6'>
            ...
            <li className='w-6 h-6 flex items-center justify-center hover:opacity-80 transition-opacity'>
              ...
              >
                <path
                  d='M0 0V30H40V0H0ZM35.8633 3.33333L20 16.1883L4.13667 3.33333H35.8633ZM3.33333 26.6667V6.97167L20 20.4783L36.6667 6.97167V26.6667H3.33333Z'
                  fill='white'
                />
              </svg>
            </li>
            ...
            <li className='w-6 h-6 flex items-center justify-center hover:opacity-80 transition-opacity'>
              ...
              >
                <path
                  d='M8.4 8.9L8.9 6H6V4.2c0-0.8 0.4-1.6 1.7-1.6H9V0.2C9 0.2 7.8 0 6.6 0c-2.4 0-4 1.4-4 3.9v2.2H0V9h2.7v6.9C3.2 16 3.8 16 4.3 16s1.1 0 1.6-0.1v-7H8.4'
                  fill='white'
                />
              </svg>
            </li>
            ...
            <li className='w-6 h-6 flex items-center justify-center hover:opacity-80 transition-opacity'>
              ...
              >
                <path
                  d='M19.3,15.4c0,2.5-2,4.5-4.5,4.5H6.1c-2.5,0-4.5-2-4.5-4.5V6.1c0-2.5,2-4.5,4.5-4.5h8.7c2.5,0,4.5,2,4.5,4.5V15.4z M14.8,0H6.1C2.7,0,0,2.7,0,6.1v9.3c0,3.4,2.7,6.1,6.1,6.1h8.7c3.4,0,6.1-2.7,6.1-6.1V6.1C20.9,2.7,18.2,0,14.8,0'
                  fill='white'
                />
                <path
                  d='M10.5,14.7c-2.2,0-4-1.8-4-4s1.8-4,4-4s4,1.8,4,4S12.7,14.7,10.5,14.7 M10.5,4.9c-3.2,0-5.8,2.6-5.8,5.8s2.6,5.8,5.8,5.8s5.8-2.6,5.8-5.8C16.2,7.5,13.7,4.9,10.5,4.9'
                  fill='white'
                />
                <path
                  d='M16.3,3.5c-0.8,0-1.4,0.6-1.4,1.4c0,0.8,0.6,1.4,1.4,1.4c0.8,0,1.4-0.6,1.4-1.4S17.1,3.4,16.3,3.5L16.3,3.5'
                  fill='white'
                />
              </svg>
            </li>
          ...
          <ul className='grid grid-cols-2 gap-x-4 gap-y-2 text-white'>
            {[
              ...
              <li key={link.name} className='group relative block w-full pb-1'>
                ...
                <span className='absolute bottom-0 left-0 w-0 h-px bg-brand-red transition-all duration-200 ease-in-out group-hover:w-full pointer-events-none' />
              </li>
            ))}
          </ul>
        </div>
        ...
        <div>
          <h3 className='font-bold text-white mb-4 tracking-wider'>
            Explore Our Portfolio Brand Sites
          </h3>
          <ul className='grid grid-cols-2 gap-x-4 gap-y-2 text-white'>
            {[
              {
                name: 'SATS Cargo',
                href: 'https://www.satscargo.com/portal/io/'
              },
              ...
              {
                name: "Monty's Bakehouse",
                href: 'https://montysbakehouse.co.uk/'
              }
            ].map(link => (
              <li key={link.name} className='group relative block w-full pb-1'>
                <a
